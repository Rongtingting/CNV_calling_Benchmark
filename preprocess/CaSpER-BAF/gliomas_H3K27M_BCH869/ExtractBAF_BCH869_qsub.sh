...
#PBS -o /groups/cgsd/rthuang/Results/gliomas_H3K27M_BCH869/CaSpER-log/BCH869_EXtractBAF_hg19.log
# The path and file name for standard error.****
#PBS -e /groups/cgsd/rthuang/Results/gliomas_H3K27M_BCH869/CaSpER-log/BCH869_EXtractBAF_hg19.err
# =================================================================================
...
# =================================================================================**
# run the program****
echo "Rongting's Notes: start the Project!--CaSpER-ExtractBAF"
sh /home/rthuang/ResearchProject/CaSpER/src/gliomas_H3K27M_BCH869/ExtractBAF_BCH869.sh
echo "Rongting's Notes: stop the Project--CaSpER-ExtractBAF"
# =================================================================================**
conda deactivate
