# gen_call.prostate.py - generate running scripts for CNV calling on prostate dataset by each tool.
...
'''
    ...
    s += '''
cp  %s/prostate/scRNA_CaSpER/casper.rna.R  $work_dir
cp  %s/prostate/scRNA_CaSpER/casper.rna.plot.R  $work_dir
...
'''
    ...
    s += '''
cp  %s/prostate/scRNA_copyKAT/copykat.rna.R  $work_dir
...
'''
    ...
    s += '''
cp  %s/prostate/scRNA_inferCNV/infercnv.rna.R  $work_dir
''' % (conf.repo_scripts_dir, )
...
cp  %s/prostate/scRNA_numbat_preprocess/numbat.preprocess.R  $work_dir
''' % (conf.repo_scripts_dir, conf.repo_scripts_dir)
...
'''
    ...
    s += '''
cp  %s/prostate/scRNA_numbat/numbat.rna.R  $work_dir
''' % (conf.repo_scripts_dir, )
