...
/usr/bin/time -v Rscript $work_dir/casper.rna.R \
  ...
  snp.BAF.tsv  \
  $project_dir/output/GX109_casper_stem
...
/usr/bin/time -v Rscript $work_dir/casper.rna.plot.R \
  GX109  \
  $project_dir/output/GX109_casper_stem/GX109.final_chr_mat.rds \
  $project_dir/output/GX109_casper_stem/GX109.loh.median.filtered.data.rds \
  $project_dir/output/GX109_casper_stem
