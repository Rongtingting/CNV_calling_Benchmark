...
/usr/bin/time -v Rscript $work_dir/rna.rand_index.R \
  BCH869  \
  $project_dir/output/BCH869_evaluate/cluster  \
  cluster.k.*.rds  \
  2,3,4,5,6,7,8   \
  $project_dir/input/BCH869/scRNA/BCH869.cluster.ground.truth.csv \
  $project_dir/output/BCH869_evaluate/rand_index/k2
...
/usr/bin/time -v Rscript $work_dir/rna.rand_index.R \
  ...
  $project_dir/output/BCH869_evaluate/rand_index/k4

# for the 492 cells

/usr/bin/time -v Rscript $work_dir/rna.rand_index.R \
  BCH869  \
  $project_dir/output/BCH869_evaluate_492/cluster  \
  cluster.k.*.rds  \
  2,3,4,5,6,7,8   \
  $project_dir/input/BCH869/scRNA/BCH869.cluster.ground.truth.csv \
  $project_dir/output/BCH869_evaluate_492/rand_index/k2
...
/usr/bin/time -v Rscript $work_dir/rna.rand_index.R \
  ...
  2,3,4,5,6,7,8   \
  $project_dir/output/BCH869_preprocess/BCH869.clone.anno.sort.csv \
  $project_dir/output/BCH869_evaluate_492/rand_index/k4
