...
#PBS -N gx109-copykat-unclassified
#PBS -q cgsd
#PBS -l nodes=1:ppn=20,mem=400g,walltime=400:00:00
#PBS -o gx109_copykat_unclassified.out
#PBS -e gx109_copykat_unclassified.err
...
for i in 1 2 3; do
  /usr/bin/time -v Rscript $work_dir/copykat.rna.R \
    ...
    unclassified \
    $project_dir/output/GX109_copykat_repeats/run/unclassified_$i
done
